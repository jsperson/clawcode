...
2. **Edit** the YAML to add, modify, remove, or enable/disable tasks
3. **Run** `scripts/schedule-sync.py` to push changes to launchd

Always do both steps — editing the YAML alone does nothing until sync runs.
